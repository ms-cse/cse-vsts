 //========= Input Vars ================================
var clientId = '080c1615-76d7-4ba0-97c7-3e57aab018d0';
var replyUri = window.location.href;
var vstsApi = 'https://cseng.visualstudio.com/_apis/projects?api-version=2.0';
...
$(document).ready(function () {
    ...
    $('#selectProjectBtn').on('click', function(e) {
        ...
        console.log('clicked');
        var data_id = $('table.project-table tr.selected').attr('data-id');

        if(data_id && projectData[data_id]) {
            var project = projectData[data_id];
...
function createAutocomplete(activityData) {
    ...
    console.log('creating autocomplete with data', autoCompleteData);
